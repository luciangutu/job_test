...
for i in range(len(expense_report)):
    for j in range(len(expense_report)):
        for k in range(len(expense_report)):
            if int(expense_report[i]) > 1900 or int(expense_report[j]) > 1900 or int(expense_report[k]) > 1900:
                continue
            if int(expense_report[i]) + int(expense_report[j]) + int(expense_report[k]) == 2020:
                ...
                print(int(expense_report[i]) * int(expense_report[j]) * int(expense_report[k]))
                exit()
